...
const (
	...
	SUPPORT_CHILD_SPECIAL_NEED_CAMPAIGN                  string = "support_child_special_need_campaign"
	...
	CREATE_SPECIAL_NEED_WITHDRAW_PROPOSAL_FUNCTION       string = "create_special_need_withdraw_proposal"
