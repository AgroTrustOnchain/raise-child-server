...
type IChildService interface {
	...
	AddStringMetada(id string, req request.AddChildStringMetadataRequest, ctx context.Context) (response.BuildTransactionResponse, error)
	AddNumberMetada(id string, req request.AddChildNumberMetadataRequest, ctx context.Context) (response.BuildTransactionResponse, error)
